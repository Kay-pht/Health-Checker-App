const prompt = (answers) => {
    return [
        {
            role: "system",
            content: "あなたは栄養アドバイザーとして、ユーザーの食生活データを分析し、個別化された精密なフィードバックを提供します。ユーザーが入力した食生活の摂取頻度データに基づいて、不足している栄養素を正確に特定し、その栄養素を補う最適な食材を提案します。",
        },
        {
            role: "user",
            content: "ユーザーの食生活の摂取頻度データを詳細に分析し、次の手順とフォーマットに従って、「不足栄養素」、「食生活のスコア（100点満点）」、「推奨食材（4品目以上）」を返答してください。\n\n" +
                "【分析手順】\n" +
                "1. 各食品群の摂取頻度（f1～f4）を元に、どの栄養素が不足しているかを特定します。\n" +
                "   - f1（ほとんど食べない）やf2（週2～3日）の頻度が高い食品群を優先的に分析し、それらの栄養素が不足していると判断します。\n" +
                ...
                "     - 85点以上: 栄養バランスが良好で、ほとんどの重要な栄養素が適切に摂取されています。これがユーザーの平均点となるように設計します。\n" +
                "     - 75点以上: 栄養バランスに若干の偏りがあり、いくつかの重要な栄養素が不足しています。未入力が5項目以上の最高得点は75点までとする。\n" +
                "     - 65点以上: 栄養バランスに欠けており、複数の重要な栄養素が不足しています。これが最低点となります。ただし、未入力が10項目以上の場合は60点未満とする。\n" +
                "3. 推奨食材の選定\n" +
                "   - 不足している栄養素を補うために、4品目以上の食材を提案。\n" +
                "   - 食材は栄養素を効率よく補うものを選び、各栄養素を補完する食材を組み合わせる。\n" +
                "【出力条件】\n" +
                "出力は以下のフォーマットに厳密に従ってください。これ以外の形式での出力は一切禁止。\n" +
                "フォーマット例:\n" +
                '{"missingNutrients": ["例: 鉄分", "例: ビタミンC"], "recommendedFoods": ["例: キウイ", "例: 小魚"], "score": 例: 93}\n\n' +
                "【摂取頻度】\n" +
                "摂取頻度は以下の通り:\n" +
                "f1: ほとんど食べない, f2: 週2～3日, f3: 週4～5日, f4: ほぼ毎日。\n\n" +
                "【質問内容】\n" +
                "質問内容は次の通り。\n" +
